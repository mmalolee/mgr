...
\begin{document}
tutaj ladna strona tytulowa wstep teoretyczny i przeglad literatury i bibliografia

\tableofcontents

\include{rozdzialy/1_zbiory_danych}
\include{rozdzialy/2_srodowisko_badawcze}
\include{rozdzialy/3_trening_modeli_przebieg_badan}
\include{rozdzialy/4_analiza_badań_mnist}
\include{rozdzialy/5_analiza_badan_cifar}
\include{rozdzialy/6_analiza_porownawcza}
\include{rozdzialy/7_podsumwoanie}
